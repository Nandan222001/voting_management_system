...
const styles = StyleSheet.create({
  ...
  heroSearchWrapper: { flexDirection: 'row', alignItems: 'center', borderRadius: ms(8), height: vs(54), paddingHorizontal: hs(16), borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)' },
  ...
  modernAvatarContainer: { width: ms(56), height: ms(56), borderRadius: ms(14), borderWidth: 2, borderColor: COLORS.primary + '20', padding: 2, position: 'relative' },
