...
const styles = StyleSheet.create({
  ...
  heroSearchWrapper: { flexDirection: 'row', alignItems: 'center', borderRadius: ms(16), height: vs(54), paddingHorizontal: hs(16), borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)' },
  heroSearchInput: { flex: 1, color: '#fff', fontSize: ms(16), fontWeight: '600', paddingVertical: 0, backgroundColor: 'transparent', ...Platform.select({ web: { outlineStyle: 'none' } }) },
  peopleList: { gap: vs(20), marginTop: vs(8) },
  targetCard: { 
    backgroundColor: '#fff', borderRadius: ms(24), overflow: 'hidden', borderWidth: 1, borderColor: COLORS.outlineVariant,
    ...Platform.select({
  ...
  targetHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: ms(16), backgroundColor: COLORS.primaryContainer + '30', borderBottomWidth: 1, borderBottomColor: COLORS.outlineVariant },
  targetTitleRow: { flexDirection: 'row', alignItems: 'center', gap: hs(8) },
  targetName: { fontSize: ms(16), fontWeight: '800', color: COLORS.primary },
  targetTypeBadge: { backgroundColor: COLORS.primary, paddingHorizontal: hs(8), paddingVertical: vs(2), borderRadius: ms(6) },
  targetTypeText: { fontSize: ms(9), fontWeight: '800', color: '#fff' },
  leadershipBody: { padding: ms(16), gap: vs(16) },
  cardDivider: { height: 1, backgroundColor: COLORS.outlineVariant, opacity: 0.4 },
  modernPersonRow: { flexDirection: 'row', alignItems: 'center', gap: hs(16) },
  personAvatarCol: { width: hs(60) },
  modernAvatarContainer: { width: ms(56), height: ms(56), borderRadius: ms(28), borderWidth: 2, borderColor: COLORS.primary + '20', padding: 2, position: 'relative' },
  modernPersonImg: { width: '100%', height: '100%', borderRadius: ms(24), backgroundColor: '#f1f5f9' },
  verifiedBadgeSmall: { position: 'absolute', bottom: vs(-2), right: hs(-2), backgroundColor: COLORS.primary, width: ms(18), height: ms(18), borderRadius: ms(9), justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#fff' },
  personInfoCol: { flex: 1, gap: vs(2) },
  personRoleLabel: { fontSize: ms(9), fontWeight: '800', color: COLORS.onSurfaceVariant, opacity: 0.6, letterSpacing: 1 },
  modernPersonName: { fontSize: ms(16), fontWeight: '700', color: COLORS.onSurface },
  personMetaRow: { flexDirection: 'row', alignItems: 'center', gap: hs(4), marginTop: vs(2) },
  personMetaText: { fontSize: ms(12), color: COLORS.onSurfaceVariant, opacity: 0.8 },
  ...
  paginationContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: ms(6), borderRadius: ms(30), borderWidth: 1, borderColor: COLORS.outlineVariant, ...Platform.select({ ios: { shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12 }, android: { elevation: 4 } }) },
  pageBtn: { width: ms(44), height: ms(44), borderRadius: ms(22), justifyContent: 'center', alignItems: 'center', backgroundColor: COLORS.primaryContainer },
  pageBtnDisabled: { opacity: 0.2 },
  pageNumbersRow: { flexDirection: 'row', marginHorizontal: hs(8), gap: hs(6) },
  pageNumberBtn: { minWidth: ms(44), height: ms(44), borderRadius: ms(22), justifyContent: 'center', alignItems: 'center', paddingHorizontal: hs(12) },
  ...
  modalContent: { backgroundColor: COLORS.background, borderTopLeftRadius: ms(32), borderTopRightRadius: ms(32), overflow: 'hidden' },
  ...
  closeBtn: { width: ms(40), height: ms(40), borderRadius: ms(20), backgroundColor: COLORS.background, justifyContent: 'center', alignItems: 'center' },
  modalScroll: { paddingBottom: vs(40) },
  profileHero: { paddingBottom: 0 },
  heroGradient: { padding: ms(30), alignItems: 'center', gap: vs(16) },
  heroAvatarContainer: { position: 'relative', padding: ms(4), borderRadius: ms(60), backgroundColor: 'rgba(255,255,255,0.2)' },
  heroAvatar: { width: ms(100), height: ms(100), borderRadius: ms(50), borderWidth: 4, borderColor: '#fff' },
  heroBadge: { position: 'absolute', bottom: 0, right: 0, width: ms(32), height: ms(32), borderRadius: ms(16), backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3 },
  heroName: { fontSize: ms(24), fontWeight: '900', color: '#fff', textAlign: 'center' },
  heroTagPill: { backgroundColor: 'rgba(0,0,0,0.2)', paddingHorizontal: hs(12), paddingVertical: vs(4), borderRadius: ms(20) },
  heroTagText: { color: '#fff', fontSize: ms(10), fontWeight: '800', letterSpacing: 1 },
  profileBody: { padding: ms(20), gap: vs(20) },
  infoCard: { backgroundColor: '#fff', borderRadius: ms(24), padding: ms(20), borderWidth: 1, borderColor: COLORS.outlineVariant },
  ...
  gridItem: { flex: 1 },
  securitySeal: { flexDirection: 'row', alignItems: 'center', gap: hs(12), padding: ms(16), backgroundColor: '#10b98110', borderRadius: ms(16), marginTop: vs(10) },
