  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView 
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={['#0058e7']} />
        }
      >
        ...
        <View style={styles.summaryGrid}>
           <View style={[styles.mainStatCard, { backgroundColor: '#0058e7' }]}>
        ...
        <TouchableOpacity style={styles.ctaBanner} activeOpacity={0.9}>
           <View style={styles.ctaIcon}>
              <FontAwesome5 name="shield-alt" size={20} color="#0058e7" />
           </View>
...
const styles = StyleSheet.create({
  ...
  mainStatCard: {
    ...
    marginBottom: 16,
    ...Platform.select({
      ios: { shadowColor: '#0058e7', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 15 },
      android: { elevation: 8 }
    })
  },
