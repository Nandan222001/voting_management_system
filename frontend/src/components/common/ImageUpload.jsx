  ...
  return (
    <div className="w-full">
      <div
        ...
        className="w-full rounded-xl border-2 border-dashed border-gray-200 bg-white p-5 flex items-center justify-center cursor-pointer hover:border-indigo-300 transition-colors duration-200 ease-in-out min-h-[88px]"
      >
