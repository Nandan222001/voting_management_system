    ...
    <div className="flex items-center justify-between px-6 py-4">
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          disabled={page <= 1}
          className="w-9 h-9 flex items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:text-[#1a337e] hover:border-[#1a337e] disabled:opacity-20 transition-all shadow-sm"
        >
            ...
            p === '...' ? (
              ...
              <button
                ...
                className={`w-9 h-9 text-xs font-semibold transition-all border rounded-lg ${
                  p === page
                    ? 'bg-[#1a337e] text-white shadow-sm'
