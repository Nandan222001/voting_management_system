              ...
              {({ active, disabled }) => (
                <button
                  ...
                  className={`flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-sm font-medium transition-colors duration-150 ${
                    active ? 'bg-primary-500 text-white' : action.danger ? 'text-red-600' : 'text-gray-700'
        ...
        return (
          <>
            <Menu.Button
              ref={buttonRef}
              aria-label={label}
              className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 shadow-sm transition-all duration-150 hover:border-primary-500 hover:bg-primary-50 hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2"
            >
